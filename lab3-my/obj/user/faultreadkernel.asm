...
static void printnum_nopad(void (*putch)(int, void*), void *putdat,
  ...
  800227:	0f be 80 39 12 80 00 	movsbl 0x801239(%eax),%eax
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800375:	0f be 80 39 12 80 00 	movsbl 0x801239(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800453:	ff 24 8d 44 13 80 00 	jmp    *0x801344(,%ecx,4)
  ...
  800538:	c7 44 24 08 53 12 80 	movl   $0x801253,0x8(%esp)
  80053f:	00 
  ...
  800576:	c7 45 d0 56 12 80 00 	movl   $0x801256,-0x30(%ebp)
				p = "(null)";
			if (width > 0 && padc != '-')
...
getint(va_list *ap, int lflag)
{
  ...
  80082e:	c7 44 24 0c c8 12 80 	movl   $0x8012c8,0xc(%esp)
  800835:	00 
  800836:	c7 44 24 08 53 12 80 	movl   $0x801253,0x8(%esp)
  80083d:	00 
  ...
  800862:	c7 44 24 0c 00 13 80 	movl   $0x801300,0xc(%esp)
  800869:	00 
  80086a:	c7 44 24 08 53 12 80 	movl   $0x801253,0x8(%esp)
  800871:	00 
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800f06:	00 
  800f07:	c7 44 24 08 b8 14 80 	movl   $0x8014b8,0x8(%esp)
  800f0e:	00 
  800f0f:	c7 44 24 04 26 00 00 	movl   $0x26,0x4(%esp)
  800f16:	00 
  800f17:	c7 04 24 d5 14 80 00 	movl   $0x8014d5,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
  ...
  800f48:	c7 04 24 e3 14 80 00 	movl   $0x8014e3,(%esp)
  ...
  800f75:	c7 04 24 ec 14 80 00 	movl   $0x8014ec,(%esp)
  ...
  800f8b:	e8 10 f1 ff ff       	call   8000a0 <vcprintf>
	cprintf("\n");
  800f90:	c7 04 24 e8 14 80 00 	movl   $0x8014e8,(%esp)
