...
exit(void)
{
  ...
  800089:	e8 12 01 00 00       	call   8001a0 <sys_env_destroy>
}
  80008e:	c9                   	leave  
  80008f:	c3                   	ret    
...
sys_cputs(const char *s, size_t len)
{
  ...
  800099:	89 7c 24 04          	mov    %edi,0x4(%esp)
...
sys_cputs(const char *s, size_t len)
{
  ...
  8000ba:	8b 1c 24             	mov    (%esp),%ebx
  8000bd:	8b 7c 24 04          	mov    0x4(%esp),%edi
...
sys_cgetc(void)
{
  ...
  8000ce:	89 7c 24 04          	mov    %edi,0x4(%esp)
...
sys_cgetc(void)
{
  ...
  8000f0:	8b 1c 24             	mov    (%esp),%ebx
  8000f3:	8b 7c 24 04          	mov    0x4(%esp),%edi
...
sys_getenvid(void)
{
  ...
  800101:	89 1c 24             	mov    %ebx,(%esp)
  800104:	89 7c 24 04          	mov    %edi,0x4(%esp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  80010d:	b8 02 00 00 00       	mov    $0x2,%eax
...
sys_getenvid(void)
{
  ...
  800126:	8b 1c 24             	mov    (%esp),%ebx
  800129:	8b 7c 24 04          	mov    0x4(%esp),%edi
  80012d:	89 ec                	mov    %ebp,%esp
  80012f:	5d                   	pop    %ebp
  800130:	c3                   	ret    

00800131 <sys_map_kernel_page>:
...
sys_map_kernel_page(void* kpage, void* va)
{
  ...
  80013a:	89 7c 24 04          	mov    %edi,0x4(%esp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800143:	b8 04 00 00 00       	mov    $0x4,%eax
...
sys_map_kernel_page(void* kpage, void* va)
{
  ...
  80015e:	8b 1c 24             	mov    (%esp),%ebx
  800161:	8b 7c 24 04          	mov    0x4(%esp),%edi
  800165:	89 ec                	mov    %ebp,%esp
  800167:	5d                   	pop    %ebp
  800168:	c3                   	ret    
...
sys_sbrk(uint32_t inc)
{
  ...
  80016f:	89 1c 24             	mov    %ebx,(%esp)
  800172:	89 7c 24 04          	mov    %edi,0x4(%esp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  80017b:	b8 05 00 00 00       	mov    $0x5,%eax
  800180:	8b 55 08             	mov    0x8(%ebp),%edx
  800183:	89 cb                	mov    %ecx,%ebx
  800185:	89 cf                	mov    %ecx,%edi
  800187:	51                   	push   %ecx
  800188:	52                   	push   %edx
  800189:	53                   	push   %ebx
  80018a:	54                   	push   %esp
...
sys_sbrk(uint32_t inc)
{
  ...
  800195:	8b 1c 24             	mov    (%esp),%ebx
  800198:	8b 7c 24 04          	mov    0x4(%esp),%edi
  80019c:	89 ec                	mov    %ebp,%esp
  80019e:	5d                   	pop    %ebp
  80019f:	c3                   	ret    

008001a0 <sys_env_destroy>:
	return syscall(SYS_cgetc, 0, 0, 0, 0, 0, 0);
}
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8001b1:	b8 03 00 00 00       	mov    $0x3,%eax
  ...
  8001cd:	7e 28                	jle    8001f7 <sys_env_destroy+0x57>
		panic("syscall %d returned %d (> 0)", num, ret);
  8001cf:	89 44 24 10          	mov    %eax,0x10(%esp)
  8001d3:	c7 44 24 0c 03 00 00 	movl   $0x3,0xc(%esp)
  8001da:	00 
  8001db:	c7 44 24 08 12 12 80 	movl   $0x801212,0x8(%esp)
  8001e2:	00 
  8001e3:	c7 44 24 04 26 00 00 	movl   $0x26,0x4(%esp)
  8001ea:	00 
  8001eb:	c7 04 24 2f 12 80 00 	movl   $0x80122f,(%esp)
  8001f2:	e8 0d 00 00 00       	call   800204 <_panic>
...
sys_env_destroy(envid_t envid)
{
  ...
  8001f7:	8b 5d f8             	mov    -0x8(%ebp),%ebx
...
void
_panic(const char *file, int line, const char *fmt, ...)
  80020c:	8d 75 14             	lea    0x14(%ebp),%esi
	va_list ap;
	...
	if (argv0)
  80020f:	a1 08 20 80 00       	mov    0x802008,%eax
  800214:	85 c0                	test   %eax,%eax
  800216:	74 10                	je     800228 <_panic+0x24>
		cprintf("%s: ", argv0);
  800218:	89 44 24 04          	mov    %eax,0x4(%esp)
  80021c:	c7 04 24 3d 12 80 00 	movl   $0x80123d,(%esp)
  800223:	e8 ad 00 00 00       	call   8002d5 <cprintf>
	cprintf("[%08x] user panic in %s at %s:%d: ",
  800228:	8b 1d 00 20 80 00    	mov    0x802000,%ebx
  80022e:	e8 c8 fe ff ff       	call   8000fb <sys_getenvid>
  800233:	8b 55 0c             	mov    0xc(%ebp),%edx
  800236:	89 54 24 10          	mov    %edx,0x10(%esp)
  80023a:	8b 55 08             	mov    0x8(%ebp),%edx
  80023d:	89 54 24 0c          	mov    %edx,0xc(%esp)
  800241:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  800245:	89 44 24 04          	mov    %eax,0x4(%esp)
  800249:	c7 04 24 44 12 80 00 	movl   $0x801244,(%esp)
  800250:	e8 80 00 00 00       	call   8002d5 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800255:	89 74 24 04          	mov    %esi,0x4(%esp)
  800259:	8b 45 10             	mov    0x10(%ebp),%eax
  80025c:	89 04 24             	mov    %eax,(%esp)
  80025f:	e8 10 00 00 00       	call   800274 <vcprintf>
	cprintf("\n");
  800264:	c7 04 24 42 12 80 00 	movl   $0x801242,(%esp)
  80026b:	e8 65 00 00 00       	call   8002d5 <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  800270:	cc                   	int3   
  800271:	eb fd                	jmp    800270 <_panic+0x6c>
	...
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800277:	81 ec 28 01 00 00    	sub    $0x128,%esp
	struct printbuf b;
  ...
  800294:	89 44 24 0c          	mov    %eax,0xc(%esp)
  ...
  8002a9:	c7 04 24 ef 02 80 00 	movl   $0x8002ef,(%esp)
  8002b0:	e8 0b 03 00 00       	call   8005c0 <vprintfmt>
	sys_cputs(b.buf, b.idx);
  8002b5:	8b 85 f0 fe ff ff    	mov    -0x110(%ebp),%eax
  8002bb:	89 44 24 04          	mov    %eax,0x4(%esp)
  8002bf:	8d 85 f8 fe ff ff    	lea    -0x108(%ebp),%eax
  8002c5:	89 04 24             	mov    %eax,(%esp)
  8002c8:	e8 c3 fd ff ff       	call   800090 <sys_cputs>
  ...
  8002db:	8d 45 0c             	lea    0xc(%ebp),%eax
{
  ...
  8002e8:	e8 87 ff ff ff       	call   800274 <vcprintf>
	va_end(ap);
...
putch(int ch, struct printbuf *b)
{
  ...
  8002fe:	88 54 03 08          	mov    %dl,0x8(%ebx,%eax,1)
  800302:	83 c0 01             	add    $0x1,%eax
  800305:	89 03                	mov    %eax,(%ebx)
	if (b->idx == 256-1) {
  800307:	3d ff 00 00 00       	cmp    $0xff,%eax
  80030c:	75 19                	jne    800327 <putch+0x38>
		sys_cputs(b->buf, b->idx);
  80030e:	c7 44 24 04 ff 00 00 	movl   $0xff,0x4(%esp)
  800315:	00 
  800316:	8d 43 08             	lea    0x8(%ebx),%eax
  800319:	89 04 24             	mov    %eax,(%esp)
  80031c:	e8 6f fd ff ff       	call   800090 <sys_cputs>
		b->idx = 0;
  800321:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
	}
	b->cnt++;
  800327:	83 43 04 01          	addl   $0x1,0x4(%ebx)
}
