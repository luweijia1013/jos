...
exit(void)
{
  ...
  800085:	e8 12 01 00 00       	call   80019c <sys_env_destroy>
}
  80008a:	c9                   	leave  
  80008b:	c3                   	ret    
...
sys_cputs(const char *s, size_t len)
{
  ...
  8000b9:	8b 7c 24 04          	mov    0x4(%esp),%edi
...
sys_cgetc(void)
{
  ...
  8000ca:	89 7c 24 04          	mov    %edi,0x4(%esp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800109:	b8 02 00 00 00       	mov    $0x2,%eax
...
sys_getenvid(void)
{
  ...
  800122:	8b 1c 24             	mov    (%esp),%ebx
  800125:	8b 7c 24 04          	mov    0x4(%esp),%edi
  800129:	89 ec                	mov    %ebp,%esp
  80012b:	5d                   	pop    %ebp
  80012c:	c3                   	ret    

0080012d <sys_map_kernel_page>:
...
sys_map_kernel_page(void* kpage, void* va)
{
  ...
  800136:	89 7c 24 04          	mov    %edi,0x4(%esp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  80013f:	b8 04 00 00 00       	mov    $0x4,%eax
  800144:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  800147:	8b 55 08             	mov    0x8(%ebp),%edx
  80014a:	89 df                	mov    %ebx,%edi
  80014c:	51                   	push   %ecx
  80014d:	52                   	push   %edx
  80014e:	53                   	push   %ebx
  80014f:	54                   	push   %esp
...
sys_map_kernel_page(void* kpage, void* va)
{
  ...
  80015a:	8b 1c 24             	mov    (%esp),%ebx
  80015d:	8b 7c 24 04          	mov    0x4(%esp),%edi
  800161:	89 ec                	mov    %ebp,%esp
  800163:	5d                   	pop    %ebp
  800164:	c3                   	ret    
...
sys_sbrk(uint32_t inc)
{
  ...
  80016b:	89 1c 24             	mov    %ebx,(%esp)
  80016e:	89 7c 24 04          	mov    %edi,0x4(%esp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8001ad:	b8 03 00 00 00       	mov    $0x3,%eax
  ...
  8001c9:	7e 28                	jle    8001f3 <sys_env_destroy+0x57>
		panic("syscall %d returned %d (> 0)", num, ret);
  8001cb:	89 44 24 10          	mov    %eax,0x10(%esp)
  8001cf:	c7 44 24 0c 03 00 00 	movl   $0x3,0xc(%esp)
  8001d6:	00 
  8001d7:	c7 44 24 08 02 12 80 	movl   $0x801202,0x8(%esp)
  8001de:	00 
  8001df:	c7 44 24 04 26 00 00 	movl   $0x26,0x4(%esp)
  8001e6:	00 
  8001e7:	c7 04 24 1f 12 80 00 	movl   $0x80121f,(%esp)
  8001ee:	e8 0d 00 00 00       	call   800200 <_panic>
...
sys_env_destroy(envid_t envid)
{
  ...
  8001f3:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  8001f6:	8b 7d fc             	mov    -0x4(%ebp),%edi
  8001f9:	89 ec                	mov    %ebp,%esp
  8001fb:	5d                   	pop    %ebp
  8001fc:	c3                   	ret    
  8001fd:	00 00                	add    %al,(%eax)
	...
...
void
_panic(const char *file, int line, const char *fmt, ...)
  800208:	8d 75 14             	lea    0x14(%ebp),%esi
	va_list ap;
	...
	if (argv0)
  80020b:	a1 08 20 80 00       	mov    0x802008,%eax
  800210:	85 c0                	test   %eax,%eax
  800212:	74 10                	je     800224 <_panic+0x24>
		cprintf("%s: ", argv0);
  800214:	89 44 24 04          	mov    %eax,0x4(%esp)
  800218:	c7 04 24 2d 12 80 00 	movl   $0x80122d,(%esp)
  80021f:	e8 ad 00 00 00       	call   8002d1 <cprintf>
	cprintf("[%08x] user panic in %s at %s:%d: ",
  800224:	8b 1d 00 20 80 00    	mov    0x802000,%ebx
  80022a:	e8 c8 fe ff ff       	call   8000f7 <sys_getenvid>
  80022f:	8b 55 0c             	mov    0xc(%ebp),%edx
  800232:	89 54 24 10          	mov    %edx,0x10(%esp)
  800236:	8b 55 08             	mov    0x8(%ebp),%edx
  800239:	89 54 24 0c          	mov    %edx,0xc(%esp)
  80023d:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  800241:	89 44 24 04          	mov    %eax,0x4(%esp)
  800245:	c7 04 24 34 12 80 00 	movl   $0x801234,(%esp)
  80024c:	e8 80 00 00 00       	call   8002d1 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800251:	89 74 24 04          	mov    %esi,0x4(%esp)
  800255:	8b 45 10             	mov    0x10(%ebp),%eax
  800258:	89 04 24             	mov    %eax,(%esp)
  80025b:	e8 10 00 00 00       	call   800270 <vcprintf>
	cprintf("\n");
  800260:	c7 04 24 32 12 80 00 	movl   $0x801232,(%esp)
  800267:	e8 65 00 00 00       	call   8002d1 <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  80026c:	cc                   	int3   
  80026d:	eb fd                	jmp    80026c <_panic+0x6c>
	...
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  8002a5:	c7 04 24 eb 02 80 00 	movl   $0x8002eb,(%esp)
  8002ac:	e8 ff 02 00 00       	call   8005b0 <vprintfmt>
  ...
  8002c4:	e8 c3 fd ff ff       	call   80008c <sys_cputs>
...
putch(int ch, struct printbuf *b)
{
  ...
  8002f2:	8b 5d 0c             	mov    0xc(%ebp),%ebx
	b->buf[b->idx++] = ch;
  8002f5:	8b 03                	mov    (%ebx),%eax
  8002f7:	8b 55 08             	mov    0x8(%ebp),%edx
  8002fa:	88 54 03 08          	mov    %dl,0x8(%ebx,%eax,1)
  8002fe:	83 c0 01             	add    $0x1,%eax
  800301:	89 03                	mov    %eax,(%ebx)
	if (b->idx == 256-1) {
  800303:	3d ff 00 00 00       	cmp    $0xff,%eax
  800308:	75 19                	jne    800323 <putch+0x38>
		sys_cputs(b->buf, b->idx);
  80030a:	c7 44 24 04 ff 00 00 	movl   $0xff,0x4(%esp)
  800311:	00 
  800312:	8d 43 08             	lea    0x8(%ebx),%eax
  800315:	89 04 24             	mov    %eax,(%esp)
  800318:	e8 6f fd ff ff       	call   80008c <sys_cputs>
		b->idx = 0;
